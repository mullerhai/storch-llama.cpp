...
ThisBuild / scmInfo := Some( ScmInfo( url( "https://github.com/mullerhai/storch-llama.cpp" ), "scm:git:https://github.com/mullerhai/storch-llama.cpp.git" ) )
